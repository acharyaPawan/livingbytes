  ...
  return (
    <div className="space-y-6 py-10">
      <section className="rounded-3xl border border-white/40 bg-white/70 p-8 shadow-sm dark:border-white/10 dark:bg-white/5">
        <p className="text-xs uppercase tracking-[0.2em] text-slate-500">Writings</p>
        <h1 className="mt-3 text-3xl font-semibold text-slate-900 dark:text-white">
          Coming soon
        </h1>
        <p className="mt-3 text-sm text-slate-600 dark:text-slate-300">
          Writing studio is coming soon. Draft essays, brainstorms, and long-form notes without losing your flow.
        </p>
